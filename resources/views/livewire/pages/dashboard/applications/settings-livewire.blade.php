         ...
         <div class="flex flex-col">
             <div class="lg:mt-6 border-t pt-6 dark:border-gray-700">
                 <form wire:submit.prevent="submit" class="">
                     ...
                     @endif
                     <div
                         class="flex justify-between items-center rounded-3xl bg-white  dark:bg-wedic-blue-800 border dark:border-gray-700 p-8 lg:p-10 mt-6">
                     ...
                     <div
                         ...
                         <div class="flex flex-col  w-full lg:w-[60%]">
                             ...
                             <div class="grid lg:grid-cols-2 grid-cols-1 gap-4 w-full">
                                 <div class="w-full">
                                     <x-label for="Newdegree"
                                         class="block text-sm font-medium text-gray-700">{{ __('application_form.highest_degree') }}</x-label>
                                     <x-input type="file" name="Newdegree" id="Newdegree" name="Newdegree"
                                         wire:model.live="Newdegree" class="w-full" />
                                     <x-input-error for="Newdegree" class="mt-2" />
                                 ...
                                 <div class="">
                                     <x-label for=""
                                         class="block text-sm font-medium text-gray-700">{{ __('application_form.experience') }}</x-label>
                         ...
                         <div class="flex flex-col   w-full lg:w-[60%]">
                             <div class="grid lg:grid-cols-2 grid-cols-1 gap-4 ">
                                 <div class="">
                                     ...
                                     <x-input type="file" name="Newresume" id="Newresume" wire:model.live="Newresume"
                                         class="w-full" placeholder="" />
                                     <x-input-error for="Newresume" class="mt-2" />
                                     <div class="flex mt-4">
                                         <a href="javascript:void(0);"
                                             class="bg-gray-200 border-dotted dark:bg-gray-900 dark:border-gray-700 py-2 px-3 rounded-lg border border-gray-300 items-center gap-2 flex hover:cursor-pointer dark:hover:bg-wedic-blue-800 hover:bg-gray-300"
         ...
         <script>
             function openFileModal(url) {
                 $.magnificPopup.open({
                     ...
                     type: 'iframe', // You can adjust this based on the file type
                 });
             }
         </script>
 </section>
