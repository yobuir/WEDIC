            ...
            <section class="containe mx-auto">
                <div class="flex flex-col gap-6">
                    <form
                        ...
                        method="POST" action="{{ route('dashboard.store.edit.update', $product->id) }}"
                        class="">
                        ...
                        <div class="flex w-full mt-4 gap-3 flex-col">
                            ...
                            <textarea id="editor" name="description" placeholder="Write here" value="{{ $product->description }}">{{ $product->description }}</textarea>
                        </div>
                        <div class="">
                            <x-button class="">
                                <span> {{ __('Save') }}</span>
                    ...
                    @livewire('pages.dashboard.store.product-store', ['id' => $product?->id])
                </div>
            </section>
        </div>
    </div>
